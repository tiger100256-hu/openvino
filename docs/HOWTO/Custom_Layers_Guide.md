...
> an additional device using one of the plugins automating device choice: [Auto-Device](../OV_Runtime_UG/supported_plugins/AUTO.md),[Multi-Device](../OV_Runtime_UG/supported_plugins/MULTI.md), or [Heterogeneous](../OV_Runtime_UG/supported_plugins/HETERO.md). They may be
> used to run inference on different devices depending on their operation support capabilities.
