...
> an additional device using one of the plugins automating device choice: [Auto-Device](../IE_DG/supported_plugins/AUTO.md),[Multi-Device](../IE_DG/supported_plugins/MULTI.md), or [Heterogeneous](../IE_DG/supported_plugins/HETERO.md). They may be
